...
3. Read `docs/technical_architecture.md` and `docs/phase_1_product_scope.md` when the task touches architecture or Phase 1 behavior. Record unresolved product decisions instead of silently choosing a rule.
